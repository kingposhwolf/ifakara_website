                            ...
                            <div class="card">
                                <div class="card-body">
                                    <button class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#custom-modal-service">Create video Libary</button>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$item->date}}</td>
                                                <td>
                                                    <img src="{{ asset('admin/assets/images/videos/' . $item->image) }}" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />

                                                </td>
                                                <td>{{$item->link}}</td>
                                                <td>
                                                    <a href="{{route('Single_video',$item->id)}}" class="action-icon"> <i class="mdi mdi-eye"></i></a>
                                                </td>
                                            </tr>
                                            @endforeach
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-light">
                    <h4 class="modal-title" id="myCenterModalLabel">Add video Library</h4>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body p-4">
                    <form action="{{route('library_video_store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
