                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Update Parish</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <form action="{{ url('admin/update_parish/'.$parish->id) }}" method="POST" enctype="multipart/form-data">
                                                @csrf
                                                @method('PUT')
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 mb-3">
                                                        @if ($parish->image)
                                                    <img src="{{ asset('admin/assets/images/parish/'.$parish->image) }}" alt="News image" width="100" height="60" class="edicat-image">
                                                     @endif
                                                    ...
                                                    <div class="mb-3 col-12">
                                                        ...
                                                        name="p_o_box" value="{{ $parish->p_o_box }}">
                                                    </div>
                                                    <div class="text-end">
